...
THREE.ShaderLib['sky'] = {
	...
	fragmentShader: [
		...
		"{",
			...
			//"gl_FragColor.rgb = vec3(0, mieDirectionalG, 0);",
...
THREE.Sky = function () {
	...
	this.setTimeOfDay(8.0);

};

THREE.Sky.prototype.setTimeOfDay = function(hour) {
	// calculate inclination from time of day
	// sunrise: 8h (inclination 0.5, azimuth +)
	// sunset: 19h (inclination 0.5, azimuth -)
	// 
	var sunrise = 8.0;
	var sunset = 19.0;
